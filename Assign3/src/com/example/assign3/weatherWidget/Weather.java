...
public class Weather extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String cityLink = bundle.getString("theCityLink");
		String cityName = bundle.getString("theCityName");
		setTitle(cityName);
	...
	private class myListAdabter extends ArrayAdapter<WeatherForecast> {
		...
		public myListAdabter() {
			super(Weather.this, R.layout.weather_item_view, report
					.getForcastList());
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (itemView == null) {
				itemView = getLayoutInflater().inflate(
						R.layout.weather_item_view, parent, false);
			}
			...
			// ****set the period
			TextView _timePeriod = (TextView) itemView
					.findViewById(R.id.item_period);
			String period = forecast.getStartHHMM() + " to "
					+ forecast.getEndHHMM();
			...
			// *****set the wind speed
			TextView _windSpeed = (TextView) itemView
					.findViewById(R.id.item_windSpeed);
			_windSpeed.setText("" + forecast.getWindSpeed() + "Km/h");
			// ****set the wind direction
			TextView _windDirection = (TextView) itemView
					.findViewById(R.id.item_windDirection);
			_windDirection.setText(forecast.getWindDirection());
			// ****set the rain volume
			TextView _rainVolume = (TextView) itemView
					.findViewById(R.id.item_rain);
			_rainVolume.setText("" + forecast.getRain() + " cm");
			return itemView;
